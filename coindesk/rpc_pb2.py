...
_NODEMETRICTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='BETWEENNESS_CENTRALITY', index=0, number=0,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_FLOATVALUE = _descriptor.Descriptor(
  name='FloatValue',
  full_name='lnrpc.FloatValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='lnrpc.FloatValue.value', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='normalized_value', full_name='lnrpc.FloatValue.normalized_value', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NODEMETRICSRESPONSE_BETWEENNESSCENTRALITYENTRY.fields_by_name['value'].message_type = _FLOATVALUE
...
FloatValue = _reflection.GeneratedProtocolMessageType('FloatValue', (_message.Message,), {
  ...
  '__module__' : 'rpc_pb2'
  # @@protoc_insertion_point(class_scope:lnrpc.FloatValue)
  })
